...
matrix_list_lu=("Sandia/ASIC_680k" "Freescale/Freescale1" "Janna/ML_Geer" "Janna/ML_Laplace" "Janna/Transport" "VLSI/dgreen" "Martin/marine1" "VLSI/nv2" "VLSI/ss" "VLSI/stokes")
