...
for ngpus in "${ngpu_array[@]}"; do
    ...
    for matrix in "${matrix_array[@]}"; do
        for npara in "${npara_array[@]}"; do
            ...
            echo "${srun_hsw_p100} ${subtreeRoot_batched} ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx > ${log_name}"
            pkill cholmod_l_batched_demo
            ${srun_hsw_p100} ${subtreeRoot_batched} ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx ${matrix_path}/${matrix}.mtx > ${log_name}
